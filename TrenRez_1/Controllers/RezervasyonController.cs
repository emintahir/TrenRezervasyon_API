    ...
    public class RezervasyonController : ControllerBase
    {
        ...
        public Rezervasyon RezList
        {
            get
            {
                ...
                rezervasyon1.Tren.Vagonlar[0] = new Vagon() {Ad = "Vagon 1", Kapasite = 100, DoluKoltukAdet = 50};
                rezervasyon1.Tren.Vagonlar[1] = new Vagon() { Ad = "Vagon 2", Kapasite = 90, DoluKoltukAdet = 70 };
                rezervasyon1.Tren.Vagonlar[2] = new Vagon() { Ad = "Vagon 3", Kapasite = 80, DoluKoltukAdet = 30 };
